...
// test suite
contract('Nabootest', function(accounts){
  ...
  it("should throw an exeption if you try to buy an article when throw is no article for sale", function() {
    return Nabootest.deployed().then(function(instance) {
  ...
  it("should throw an exeption if you try to buy an article that does not exist", function() {
    return Nabootest.deployed().then(function(instance){
      chainListInstance = instance;
